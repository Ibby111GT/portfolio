        ...
        current.map((device, index) => {
          ...
          return {
            ...
            rssi:
              device.rssi === null
                ? null
                : Math.round(device.rssi + drift * 0.12),
  ...
  return (
    <main className="min-h-screen bg-[#050807] px-4 pb-28 pt-28 text-white sm:px-6 md:pt-32">
      <div className="mx-auto max-w-[1500px]">
        ...
        <header className="mt-8 grid gap-8 lg:grid-cols-[1fr_auto] lg:items-end">
          <div>
            <div className="flex items-center gap-3">
              ...
              <p className="font-mono text-[10px] uppercase tracking-[0.24em] text-emerald-200/65">
        ...
        <section className="mt-10 rounded-[1.75rem] border border-emerald-300/20 bg-emerald-300/[0.035] p-5 md:p-6" aria-labelledby="live-input-title">
          <div className="grid gap-6 lg:grid-cols-[1fr_auto] lg:items-center">
            <div>
              <p className="font-mono text-[9px] uppercase tracking-[0.18em] text-emerald-200/55">Choose the data source</p>
              ...
              <p className="mt-3 font-mono text-[10px] text-emerald-100/60" role="status" aria-live="polite">{connectionStatus}</p>
            </div>
            <div className="flex flex-wrap gap-2">
              <button type="button" onClick={connectBluetooth} disabled={isConnecting} className="inline-flex min-h-11 items-center gap-2 rounded-full bg-emerald-300 px-4 py-2 text-xs font-semibold text-black disabled:cursor-wait disabled:opacity-55">
        ...
        <section className="mt-20 border-t border-white/10 pt-14">
          ...
          <div className="mt-8 rounded-2xl border border-white/10 bg-white/[0.02] p-5">
            <div className="flex items-start gap-3">
              <Link2 size={17} className="mt-0.5 shrink-0 text-emerald-200/60" />
              <div>
